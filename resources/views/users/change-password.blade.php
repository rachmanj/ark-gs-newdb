    ...
    <div class="col-7">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="{{ route('home') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-arrow-left"></i> Back</a>
            </div>
            ...
            <form action="{{ route('users.password_update', $user->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="project" value="{{ $user->project_code }}" class="form-control" readonly>
                    </div>
