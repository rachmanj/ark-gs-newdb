            ...
            <table class="table m-0 table-hover">
                ...
                <tbody>
                    ...
                    <tr class="font-weight-bold bg-light">
                        <td>Total</td>
                        <td class="text-right">{{ number_format($data['grpo']['total_po_sent_amount'] / 1000, 2) }}</td>
                        <td class="text-right">{{ number_format($data['grpo']['total_grpo_amount'] / 1000, 2) }}</td>
                        <td class="text-right">
                            <span
                                class="badge badge-{{ $data['grpo']['total_percentage'] * 100 >= 80 ? 'success' : 'danger' }} badge-pill">
