...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('incoming.export_this_month') }}"
    ...
    <div class="modal fade" id="modal-sync">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Sync Incoming from SAP</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('incoming.sync_from_sap') }}" method="POST" id="syncForm">
                    @csrf
                    <div class="modal-body">
                        <p>Sync Incoming data from SAP SQL Server. Default date range: First day of current year to today.</p>
                        <div class="form-group">
...
@section('scripts')
    ...
    <script>
        ...
        function confirmTruncate() {
            Swal.fire({
                title: 'Are you sure?',
                text: 'This will delete all Incoming records. This action cannot be undone!',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    window.location.href = '{{ route('incoming.truncate') }}';
                }
            });
        }
