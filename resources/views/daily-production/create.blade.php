        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Daily Production</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('daily-production.store') }}" method="POST">
                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="mtd_haul_dist_actual" id="mtd_haul_dist_actual"
                                                ...
                                                value="{{ old('mtd_haul_dist_actual') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="limestone_swing_shift" id="limestone_swing_shift"
                                                ...
                                                value="{{ old('limestone_swing_shift') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="limestone_night_shift" id="limestone_night_shift"
                                                ...
                                                value="{{ old('limestone_night_shift') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shalestone_day_shift" id="shalestone_day_shift"
                                                ...
                                                value="{{ old('shalestone_day_shift') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shalestone_swing_shift"
                                                ...
                                                value="{{ old('shalestone_swing_shift') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shalestone_night_shift"
                                                ...
                                                value="{{ old('shalestone_night_shift') }}">
